    ...
    <body>
        ...
        <div class="col-sm-12 container-fluid" style="min-height: 543px;">
            <div class="col-sm-12" style="min-height: 100px;">
                <center>
                    <h2 style="color: #cc66ff;padding-top: 10px;margin-bottom:70px">Review Management</h2>
                </center>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <table class="table table-bordered" style="margin-top: -25px;">
                    ...
                    <%
                        ...
                        String query = "select restro_name,restro_review_id,restro_review_text,customer_id,date_created from restro_review";
                    ...
                    <tr style="font-size: 16px;">
                        ...
                        <td><a href="admincode/delete-review.jsp?fid=<%=rs.getString("restro_review_id")%>"  data-placement="top" data-toggle="tooltip" title="Delete"><span class="glyphicon glyphicon-trash"></span></a></td>
                                <%
                                        n++;
                                    }
                                %>
