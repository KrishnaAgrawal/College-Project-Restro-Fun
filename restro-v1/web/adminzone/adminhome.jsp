...
<!--            <div class="col-sm-4">
                <form action="admincode/search-result.jsp" method="post" class="navbar-form navbar-left" role="search" style="text-align: right">
...
<div class="col-sm-12 admin_main" style="min-height: 400px;">
        <div class="row">  
            <div class="col-sm-12 welcome" style="background-color: white;min-height: 100px;">
            <marquee behavior="alternate"><p style="font-size: 50px;padding-top: 20px;color: #cc66ff">Welcome, Admin !!</p></marquee>
        </div>
            <div class="col-sm-12 " style="min-height: 310px;">
                <div class="row">
                <img src="images/admin.jpg" style="width: 100%;height: 310px;"/>
                </div>
            </div>
...
<!--        <div class="col-sm-12 admin_main" style="min-height: 400px;">
            <div class="row">  
                <div class="col-sm-12 welcome" style="background-color: #fff; min-height: 100px;">
                    <marquee behavior="alternate"><p style="font-size: 50px;padding-top: 20px;color: #cc66ff">Welcome, Admin !!</p></marquee>
                </div>
                                <div class="col-sm-12 " style="min-height: 300px;">
                                    <div class="row">
                                        <img src="images/admin.jpg" style="width: 100%;height: 300px;"/>
                                    </div>
                                </div>
                ...
                <div class="col-sm-12"  style="margin-bottom: 2%;">
                    ...
                    <div class="col-sm-3" style="margin-bottom: 2%;margin-top: 2%;background-color: white;float: left; 
                        ...
                        <form action="admincode/search-result.jsp" method="post" >
