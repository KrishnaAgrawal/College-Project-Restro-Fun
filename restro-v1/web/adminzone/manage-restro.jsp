    ...
    <body>
        ...
        <div class="col-sm-12 container-fluid" style="min-height: 543px;">
            <div class="col-sm-12" style="min-height: 100px;">
                <center>
                    <h2 style="color: #cc66ff;padding-top: 10px;margin-bottom:70px">Restro Management</h2>
                </center>
            </div>
                ...
                <table class="table table-bordered" style="margin-top: -25px;">
                    ...
                    %>
                        ...
                        <%
                            ...
                            String query = "select restro_name,url,rating,theme1,theme2,theme3,theme4,address,city,state,date_created,id from restro_details";
                        ...
                        <tr style="font-size: 16px;">
                                ...
                                <td><%= ((rs.getString(4) != null)?(rs.getString(4)):"")+((rs.getString(5) != null)?(", "+rs.getString(5)):"")+((rs.getString(6) != null)?(", "+rs.getString(6)):"")+((rs.getString(7) != null)?(", "+rs.getString(7)):"")%></td>
                                <td><%= ((rs.getString(8) != null)?(rs.getString(8)):"")+((rs.getString(9) != null)?(", "+rs.getString(9)):"")+((rs.getString(10) != null)?(", "+rs.getString(10)):"")%></td>
                                <td><%= rs.getString(11)%></td>
                                 <td>
                                     <a href="show-more-details.jsp?fid=<%=rs.getString(12)%>"  data-placement="top" data-toggle="tooltip" title="View"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp;
                                    <a href="admincode/update-restro.jsp?fid=<%=rs.getString(12)%>"  data-placement="top" data-toggle="tooltip" title="Update"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;
                                    <a href="admincode/delete-restro.jsp?fid=<%=rs.getString(12)%>"  data-placement="top" data-toggle="tooltip" title="Delete"><span class="glyphicon glyphicon-trash"></span></a>
                                </td>
                        <%
                            n++;}
                        %>
