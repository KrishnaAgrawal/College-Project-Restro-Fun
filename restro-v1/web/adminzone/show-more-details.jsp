    ...
    <body style="background-color:#f3f3f3">
                    ...
                    <div class="col-sm-12" style="min-height: 501px;background-color: white;margin-bottom: 5px; 
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6 text-center" style="min-height:40px;float: left;">
                                <button type="submit" class="btn"  data-placement="bottom" data-html="true"  data-toggle="tooltip" title="Admin can not give feedback!" style="color: white; background-color: #cc66ff" onclick="" >Feedback</button>
                            </div>
                            <div class="col-sm-6 text-center" style="min-height:40px;float: right">
                                <button type="submit" class="btn"  data-placement="bottom" data-html="true"  data-toggle="tooltip" title="Admin can not give reivew!"  style="color: white; background-color: #cc66ff" onclick="">Review</button>
                            </div>
        ...
        <!--Slider Restro-->
            <%
                ...
                %>
    <div class="container index-container">
                    <div class="col-sm-12 thumbnail" style="background-color: #ffccff; height: auto; width: 92.5%; margin-bottom: 0.5%">
