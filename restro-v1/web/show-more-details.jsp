...
<html>
    ...
    <body style="background-color:#f3f3f3">
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src='<%=request.getContextPath() + "/upload/" + rs.getString("image1")%>' alt="restro_pic" style="width:100%;height:350px;">
                            </div>
                            ...
                            <div class="item">
                                <img src="images/3.jpg" alt="restro_pic" style="width:100%;height:350px;">
                            </div>

                            <div class="item">
                                <img src="images/4.jpg" alt="restro_pic" style="width:100%;height:350px;">
                            </div>

                            <div class="item">
                                <img src='<%=request.getContextPath() + "/upload/" + rs.getString("image2")%>' alt="restro_pic" style="width:100%;height:350px;">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12" style="min-height: 501px;background-color: white;margin-bottom: 5px; 
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6 text-center" style="min-height:40px;float: left;">
                                <button type="submit" class="btn" style="color: white; background-color: #cc66ff" onclick="window.location.href = 'userzone/user_feedback.jsp?fid=user_feedback.jsp<%=queryString%>'" >Feedback</button>
                            </div>
                            <div class="col-sm-6 text-center" style="min-height:40px;float: right">
                                <button type="submit" class="btn" style="color: white; background-color: #cc66ff"onclick="window.location.href = 'userzone/user_review.jsp?fid=user_review.jsp<%=queryString%>'">Review</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--Slider Restro-->
            <%
                    String queryMore = null;
                    Object arrID = null;
                        queryMore = "select * from restro_details where city ='" + rs.getString("city") + "' ";
                        ResultSet rsMore = null;
                        rsMore = cm.selectQuery(queryMore);
                        while (rsMore.next()) {
                %>
    <div class="container index-container" style="">
...
<%
                ...
                out.print("<script>window.location.href='code/error.jsp'</script>");
            }
%>
</html>